          ...
          <div className="bg-white shadow-lg w-full md:w-1/2 lg:w-1/3 h-[70vh] rounded-lg  mx-auto py-5 overflow-hidden">
            <div>
              <div className="flex justify-evenly">
                <p
                  className="grid place-items-center cursor-pointer hover:text-primaryDarkGreen"
              ...
              <button
                className="h-[3px] bg-primaryGreen w-1/2 transition-all duration-500"
                ref={switcherTab}
              ></button>
            </div>
            ...
            >
              ...
              <Link
                to="/password/forgot"
                className="text-primaryGreen hover:text-primaryDarkGreen transition-all duration-500"
              >
                Forget Password ?
              </Link>
              <Button label="Login" />
