      ...
      {loading ? (
        ...
        <div className="w-full py-24 px-8 sm:15 md:px-24 flex flex-col md:flex-row justify-center bg-secColor">
          ...
          <div className="md:p-10 md:w-1/2 ">
            <div>
              <h2 className="text-primaryDarkGreen font-bold text-xl text-center mt-5 md:mt-0 md:text-left capitalize">
                {product.name}
              </h2>
            ...
            <div>
              <h1 className="text-2xl font-bold text-primaryDarkGreen text-center md:text-left">{`₹ ${product.price}`}</h1>
              ...
              <div className="flex gap-5 my-5 flex-col md:flex-row justify-center md:justify-start">
                ...
                <button
                  ...
                  className="commonBtnStyle mx-auto md:mx-0 py-2 px-5 w-full sm:w-1/2 md:w-[150px] bg-primaryGreen"
                >
                  Add to Cart
                </button>
              </div>
